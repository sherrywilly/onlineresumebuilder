...
<body>
	...
	<dd>
               ...
               <?php 
                ...
                <p><strong> <?php echo $res1['course']; ?> </strong>( <?php echo $res1['college']; ?>   )<h2><span><?php echo $res1['from_date'].'-'.$res1['to_date']; ?> </span></h2>   </p>
...
?>
                ...
                <p><strong> <?php echo $res3['post']; ?> </strong> in <?php echo $res3['company']; ?>   <h2><span><?php echo $res3['from_date'].'-'.$res3['to_date']; ?> </span></h2>   </p>
